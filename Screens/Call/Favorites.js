...
const Favorites = ({navigation}) => {
  return (
        ...
        <Text style={{fontFamily:FONT.medium,fontSize:23,color:COLORS.purple,marginHorizontal:15,marginTop:20,}} >Favorites</Text>
           ...
           cardName={'Jane Fashion Home'}
            location={'500m Away'}
            favImg={require('../../assets/Icons/favhrt.png')}
